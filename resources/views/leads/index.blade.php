<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-white leading-tight">Leads / CRM</h2>
            <a href="{{ route('leads.create') }}" class="inline-flex items-center px-4 py-2 bg-white/15 hover:bg-white/25 text-white text-xs font-semibold rounded-md">+ New Lead</a>
        </div>
    </x-slot>
