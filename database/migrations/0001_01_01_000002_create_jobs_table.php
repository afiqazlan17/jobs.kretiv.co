...
return new class extends Migration
{
    ...
    {
        // Renamed from Laravel's default 'jobs'/'job_batches'/'failed_jobs' —
        // this app's own 'jobs' table (print/production jobs) takes that
        // name instead, so the queue's tables get a 'queue_' prefix.
